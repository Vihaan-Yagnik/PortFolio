...
const About = ({id}) => {
  ...
  const { scrollYProgress } = useScroll({
    target: targetRef,
    offset: ['start end', 'end start'], // From when the top of the section hits the bottom of the viewport, to when the bottom of the section hits the top
  });
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <motion.div 
            ...
            style={{ y: textY }} // Apply parallax to the text
          >
            <span className="text-xl font-semibold text-primary mb-2">ABOUT ME</span>
            <h2 className="text-7xl font-extrabold text-base-content leading-tight mb-6">
              A commitment to excellence
            </h2>
            <p className="text-xl text-base-content opacity-70 leading-relaxed">
          ...
          <div className="md:w-1/2">
            <div className="w-full h-auto rounded-xl overflow-hidden shadow-2xl">
              {/* 5. Wrap the image in a motion.div and apply the transform */}
              <motion.img 
                style={{ y: imageY }}
